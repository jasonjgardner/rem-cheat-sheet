const main = document.getElementById('sizes'),
...
function setText() {
	fontSizeElement.innerHTML = (new CustomProperty('font-size-base')).value;
}

function setSizes(max, decimals = 4) {
	main.innerHTML = '';
	...
	while(itr--) {
		...
		size.innerHTML = '<div class="sizes__wrap">'
			+ `<p class="sizes__rem" style="font-size:${rem}rem;">${remSize}rem</p>`
